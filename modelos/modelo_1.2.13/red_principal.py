...
def entrenar_modelo(Xtrain, ytrain, Xval, yval, path_guardado='modelo_entrenado.h5'):
    ...
    model.add(LSTM(10, return_sequences=False, input_shape=(Xtrain.shape[1], Xtrain.shape[2]), kernel_initializer=initializer ) )
    ...
    try:
        ...
        model.fit(Xtrain, ytrain, epochs=250, verbose=1, batch_size=2,
